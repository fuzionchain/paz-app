      ...
      <div class="modal-dialog" role="document">
        ...
        >
          ...
          <p>
            ...
            and does not constitute investment advice. PAZ and its affiliates
            ...
            indirectly from use of or reliance on such information. All opinions
            expressed on this site are owned by the respective writer and should
            never be considered as advice in any form.
          </p>
          <p class="mb-2">
            PAZ and its affiliates makes no representation or warranties as to
            the accuracy and or timelines of the information contained herein. A
          ...
          <div class="mb-3 highlight-txt">
            ...
            &nbsp;&nbsp;&nbsp;I understand and accept that I will trade/invest
            PAZZIVE at my own risks
            <br />
            <input type="checkbox" class="number" value="Two" />
            &nbsp;&nbsp;&nbsp;I understand and accept that this app works
            smothly with Metamask/TrustWallet
            <br />
