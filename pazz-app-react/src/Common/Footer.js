    ...
    <section class="footer-section position-relative">
      <div class="custom-container">
        <div class="row">
          <div class="col-md-6">
            <img
              src="./assets/img/pazz-icon.svg"
              alt="pazz logo"
              class="footer-logo hover-magnify"
            />
            <p class="footer-txt pt-3">
              Copyright © 2021
              <a
                class="color-white"
                href="https://www.fuzion.team/"
                target="_blank"
              >
                FuzionChain.
              </a>
            ...
            <ul class="d-flex">
              <li class="mx-1">
                <a target="_blank" href="mailto:team@teslasafe.finance">
                  <img
                    ...
                    alt="gmail"
                    class="hover-magnify footer-icon"
                  />
                </a>
              </li>
              <li class="mx-1">
              ...
              <li class="mx-1">
                <a
                  target="_blank"
                  href="https://www.instagram.com/fuzionchain/"
                >
                  <img
