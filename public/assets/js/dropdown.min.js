(() => {
  ...
  class t {
    ...
    _init() {
      this._makeLayout(),
        ...
        this.ele.autofocus && this._wrapper.holder.focus();
    }
    ...
    _makeFilterBox() {
      ...
      return (
        ...
        this._bindEvents(t, "keyup", (e) => {
          (e.keyCode >= this._ALPHABETS_START ||
            e.keyCode === this._BACKSPACE ||
            e.keyCode === this._DELETE) &&
            (this._applyFilters(e), e.preventDefault(), e.stopPropagation());
        }),
        e
      );
    }
    _makeHeader() {
      let e = this._css,
        ...
        i = this._createEle("span", { className: e.arrow + " " + e.arrowDown });
      return (
        t.appendChild(s),
        t.appendChild(i),
        (this._wrapper.header = t),
        (this._wrapper.headerA = s),
        (this._wrapper.arrow = i),
        t
      );
    }
    _makeChildren(e = null) {
      ...
      this._wrapper.listOfItems
        ...
        (t.innerHTML = "");
      let h = null === e ? this.ele.children : e,
        a = h.length;
      for (let e = 0; e < a; e++) {
        let s = h[e],
          i = n(s, e),
        ...
        if (
          ...
          "" !== l.internalStyle && (d.style = l.internalStyle),
          (d.index = l.index),
          d.setAttribute("data-ms-index", l.index),
          a.isOptGroup)
        ) {
          let e = s.children,
            t = e.length,
            i = this._createEle("ul");
          for (let s = 0; s < t; s++) {
            let t = n(e[s], s),
              l = t.opt,
              h = t.itemObj,
            ...
            "" !== l.className &&
              ...
              "" !== l.internalStyle && (a.style = l.internalStyle),
              (a.index = l.index),
              a.setAttribute("data-ms-index", l.index),
              h.isSelected && this._setSelectedByItem(a, !0),
              r(a, h),
              i.appendChild(a);
          }
          d.appendChild(i);
        ...
        a.isOptGroup || r(d, a),
          t.appendChild(d),
          a.isSelected && this._setSelectedByItem(d, !0);
      }
      return (
    ...
    _makeLayout() {
      ...
      let h = this._makeHeader(),
        a = this._makeFilterBox();
      h.appendChild(a), this._showHideFilterBox(!1);
      ...
      s.appendChild(h),
        ...
        this._hide(d),
        this._bindEvents(h, this._settings.event, () => {
          this.open();
        }),
    ...
    _createRow(e) {
      ...
      let i = e.isOptGroup ? " " + this._css.itemSpanOpt : "",
        ...
        n =
          !0 === this._settings.showListCounter
      ...
      if ((l.appendChild(r), s.appendChild(l), null != e.desc.text)) {
    ...
    _parseOption(e) {
      ...
      if (void 0 !== e) {
        let _ = e.nodeName,
          c = e.dataset;
        "OPTGROUP" === _ ? (a = e.label) : ((a = e.text), (h = e.value || a)),
          (u = e.index),
          (t = e.selected),
          (s = e.disabled),
          (d = e.className || ""),
    ...
    _setSelectedByOptionItem(e) {
      let t = e.index,
        s = this._getDataAndUI(t);
      this._setSelectedByItem(s.ui);
    }
    _updateHeaderUI(e = null, t = null) {
      ...
      if (
        ("true" === this._settings.showPlusItemCounter.toString() &&
          null !== i &&
          (i += `<span class="${this._css.headerCounter}">&nbsp; (+${
            s.ui.length - 1
          })</span>`),
        (this._wrapper.headerA.innerHTML =
          null !== t ? t : i || s?.ui?.innerHTML || "&nbsp;"),
        "false" === this._settings.showIcon.toString())
      ) {
        let e = this._getEle("img", this._wrapper.headerA);
        e && this._hide(e);
      }
    ...
    _getDataAndUI(e = null) {
      let t,
        ...
        d = function (e) {
          ...
          return {
            option: t,
            data: h._parseOption(t),
            index: s,
            ui: h._findElementByIndexProp(s),
          };
        };
      if (null !== e)
        ...
        (i = d(s[0]?.index || this.selectedIndex)),
          ...
          (r = i.index || -1),
          (s = i.ui || null);
      return { data: t, ui: s, index: r, option: n, isArray: a };
    }
    _isArray = function (e) {
    ...
    _fireEventIfExist(e) {
      ...
      if (this._has_handler(e).hasEvent) {
        if (this._has_handler(e).byElement) this.ele["on" + e]();
    ...
    add(e, t = null) {
      ...
      e instanceof HTMLOptionElement
        ...
        : e instanceof Object &&
          ...
          (r = e.description || ""),
          (a = new Option(s, i)),
          a.setAttribute("data-description", r),
          a.setAttribute("data-image", n),
          a.setAttribute("data-title", l),
          a.setAttribute("data-image-css", h)),
        this.ele.add(a, t),
        this._makeChildren(),
    ...
    set selectedIndex(e) {
      e < this.length &&
        ((this.ele.selectedIndex = e),
        -1 === e
          ? (this._updateHeaderUI(null, ""), this._removeOldSelected())
          : this._setSelectedByOptionItem(this.ele.options[e]));
    }
    get options() {
  ...
  class i extends HTMLSelectElement {
    constructor(e, t) {
      super(), this.msDropdown || (this.msDropdown = new s(this));
    }
    connectedCallback() {
      try {
